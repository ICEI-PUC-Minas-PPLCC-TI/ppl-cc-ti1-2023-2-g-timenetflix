async function criarConta(event) {
    ...
    var username = document.querySelector('input[placeholder="Nome de usuário"]').value;
    ...
    try {
        const response = await fetch('https://jsonserver-conta-usuario.karencriscosta.repl.co/users', {
            method: 'POST',
            headers: {
...
async function entrarNaConta(event) {
    ...
    // Pega os valores dos campos
    var username = document.querySelector('input[placeholder="Email ou nome de usuário"]').value;
    var password = document.querySelector('input[placeholder="Senha"]').value;
    ...
    try {
        const response = await fetch(`https://jsonserver-conta-usuario.karencriscosta.repl.co/users?username=${username}&password=${password}`);
